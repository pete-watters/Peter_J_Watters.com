...
function() {
	...
	var portfolioCollection = new PortfolioCollection([
			new PortfolioModel({ title : 'Bitch Please' , description_short : 'bitchplease.ie', image : 'app/img/portfolio/bitchplease.png', modal_id : 'modal-01' , modal_href_title :'Coffesssse Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign' , demo_link : 'http://www.bitchplease.ie'}),
			new PortfolioModel({ title : 'Booterstown United' , description_short : 'booterstownunited.ie', image : 'app/img/portfolio/booterstownunited.png', modal_id : 'modal-02' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.booterstownunited.ie'}),
			new PortfolioModel({ title : 'Casino Freebies' , description_short : 'casinofreebies.com', image : 'app/img/portfolio/casinofreebies.png', modal_id : 'modal-03' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.casinofreebies.com'}),
			new PortfolioModel({ title : 'Comhairle Teicneolaiochta' , description_short : 'http://comhairleteicneolaiochta.ie/', image : 'app/img/portfolio/comhairleteic.png', modal_id : 'modal-04' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.comhairleteicneolaiochta.ie/'}),
			new PortfolioModel({ title : 'Coming soon page' , description_short : 'Coming soon', image : 'app/img/portfolio/comingsoon.png', modal_id : 'modal-05' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.google.com'}),
			new PortfolioModel({ title : 'Easy Docs' , description_short : 'EasyDocs', image : 'app/img/portfolio/easydocs.png', modal_id : 'modal-06' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.easydocs.com'}),
			new PortfolioModel({ title : 'Integra' , description_short : 'integra.ie', image : 'app/img/portfolio/integra.png', modal_id : 'modal-07' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.google.com'}),
			new PortfolioModel({ title : 'Ocuco' , description_short : 'ocuco.com', image : 'app/img/portfolio/ocuco.png', modal_id : 'modal-09' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.google.com'}),
			new PortfolioModel({ title : 'Official Football Accumulators' , description_short : 'Illustration', image : 'app/img/portfolio/officialfootballaccumulators.png', modal_id : 'modal-10' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.google.com'}),
 			new PortfolioModel({ title : 'Irene Henriksen Photography' , description_short : 'Illustration', image : 'app/img/portfolio/irenehenriksenphotography.png', modal_id : 'modal-08' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://wwwirenehenriksenphotography.com'}),
			new PortfolioModel({ title : 'My site 2014' , description_short : 'Illustration', image : 'app/img/portfolio/peter_j_w_2014.png', modal_id : 'modal-11' , modal_href_title :'Coffee Title' , description_long : 'Ooooh eee OOh ah ah', tags : 'Branding, Webdesign', demo_link : 'http://www.google.com'}),
